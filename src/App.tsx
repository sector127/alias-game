  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-xl bg-slate-900/85 backdrop-blur-xl border border-slate-800 rounded-3xl shadow-2xl shadow-purple-950/50 flex flex-col justify-between overflow-hidden relative z-10 flex-1 min-h-0">
        ...
        {/* ========================================================================= */}
        {gameState === 'ready' && (
          <div className="p-6 flex-1 flex flex-col justify-between text-center space-y-6">
            {/* Top Banner */}
            <div className="space-y-2">
              {isTieBreaker ? (
              ...
              <h2 className="text-sm font-semibold text-slate-400">მოემზადოს გუნდი</h2>
            </div>

            {/* Active Team Hero Card */}
            <div className="relative py-8 px-6 rounded-3xl bg-gradient-to-b from-slate-800/80 to-slate-900/90 border border-slate-700/60 shadow-2xl space-y-4">
              <div
                className={`w-20 h-20 mx-auto rounded-3xl bg-gradient-to-tr ${teamTheme.bg} flex items-center justify-center text-3xl font-black text-white shadow-xl shadow-purple-950/60`}
              >
                {currentTeamIndex + 1}
              </div>

              <div className="space-y-1">
                <h3 className="text-3xl sm:text-4xl font-black text-white">{currentTeam.name}</h3>
                <p className="text-sm font-semibold text-slate-400">
                  მიმდინარე ქულა: <span className="text-amber-400 font-bold">{currentTeam.score}</span> /{' '}
                  {winningScore}
                </p>
              </div>
            ...
            <div className="bg-slate-950/50 p-4 rounded-2xl border border-slate-800/60 space-y-2">
              <div className="text-xs font-bold text-slate-400 text-left">მიმდინარე ცხრილი:</div>
