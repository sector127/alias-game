...
- 👆 **Tinder-ის სტილის სვაიპის ფიზიკა (Touch Swipe Physics)**:
  - **სვაიპი მარჯვნივ 👉**: სწორი პასუხი (+1) მწვანე ნათებითა და ვიბრაციით.
  - **სვაიპი მარცხნივ 👈**: გამოტოვება (Skip) წითელი ნათებით.
  - **მართვის 3 რეჟიმი**: სვაიპი + ღილაკები (ორივე), მხოლოდ სვაიპი, ან მხოლოდ კლასიკური ღილაკები.
